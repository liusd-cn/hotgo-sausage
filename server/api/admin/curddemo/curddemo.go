...
// ImportTemplateReq 下载CURD列表导入模板
type ImportTemplateReq struct {
	g.Meta `path:"/curdDemo/importTemplate" method:"get" tags:"CURD列表" summary:"下载CURD列表导入模板"`
	sysin.CurdDemoImportTemplateInp
}

type ImportTemplateRes struct{}

// ImportReq 导入CURD列表数据
type ImportReq struct {
	g.Meta `path:"/curdDemo/import" method:"post" tags:"CURD列表" summary:"导入CURD列表数据"`
	sysin.CurdDemoImportInp
}

type ImportRes struct {
	*sysin.CurdDemoImportModel
}