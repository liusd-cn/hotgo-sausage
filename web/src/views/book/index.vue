<template>
  <div>
    <div class="n-layout-page-header">
      <n-card :bordered="false" title="书籍">
      ...
      >
        <template #tableTitle>
          ...
          <n-button
            ...
            class="min-left-space"
            v-if="hasPermission(['/book/delete'])"
          >
            <template #icon>
              <n-icon>
                <DeleteOutlined />
          ...
          <n-button
            ...
            @click="handleExport"
            class="min-left-space"
            v-if="hasPermission(['/book/export'])"
          >
            <template #icon>
              <n-icon>
                <ExportOutlined />
...
<script lang="ts" setup>
  ...
  import { List, Export, Delete } from '@/api/book';
